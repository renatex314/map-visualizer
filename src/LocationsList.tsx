import { Avatar, Card, IconButton, List, ListItemAvatar, ListItemButton, ListItemText, Paper, Typography } from "@mui/material";
import PinIcon from './assets/marker.png';
import DeleteIcon from '@mui/icons-material/Delete';
import styled from "@emotion/styled";
import { useSelector } from "react-redux";
import { getLocations, getSelectedLocationIndex, removeLocation, selectLocation } from "./app/features/locations/locationSlice";
...
const LocationsList = () => {
    ...
    return (
        <Paper sx={{margin: 0, height: '300px', overflow: 'hidden', overflowY: 'auto'}}>
            <List>
                {
                ...
                >
                    <InfoContainer onClick={() => selectLocationHandler(index)}>
                        <Icon src={PinIcon} alt="pin" style={{objectFit: 'contain'}} />
                        <ListItemText 
                    ...
                    <IconButton onClick={() => removeLocationHandler(location.getId())} sx={{marginLeft: 'auto'}}>
                        <DeleteIcon />
                    </IconButton>
                </ItemContainer>
                ))}
